...
Public Class RptStockReportLW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.RptStockReportLW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockReportLW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockReportLW = New RptStockReportLW()
        rpt.Site = Me.Site
        Return rpt
    End Function
