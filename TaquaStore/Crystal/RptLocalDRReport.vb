...
Public Class RptLocalDRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.RptLocalDRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ReportHead() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptLocalDRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLocalDRReport = New RptLocalDRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
