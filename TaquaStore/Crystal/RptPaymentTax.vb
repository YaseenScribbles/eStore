...
Public Class RptPaymentTax
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.RptPaymentTax.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPaymentTax
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPaymentTax = New RptPaymentTax()
        rpt.Site = Me.Site
        Return rpt
    End Function
