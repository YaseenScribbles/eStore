...
Public Class RptManualReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TaquaStore.RptManualReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptManualReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptManualReturn = New RptManualReturn()
        rpt.Site = Me.Site
        Return rpt
    End Function
