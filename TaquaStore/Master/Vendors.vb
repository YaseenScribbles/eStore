...
Public Class Vendors
    ...
    Private Sub Vendors_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ESSA.LoadComboSimple(cmbBank, SQL, "BANK")
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtVName.Text.Trim = "" Then
            txtVName.Focus()
            xMessage.ShowMsg("Vendor name cannot be blank..!", False, frmMainScreen, 0, xMessage.MsgStyle.iError)
            Exit Sub
        ElseIf ESSA.ISFound("Select vendorid from vendors where vendorname='" & txtVName.Text.Trim & "'" & IIf(Edit = True, " and vendorid<>" & VendorID, "")) = True Then
            xMessage.ShowMsg("Vendor name already exists..!", False, frmMainScreen, 0, xMessage.MsgStyle.iError)
            txtVName.Focus()
            Exit Sub
        End If
