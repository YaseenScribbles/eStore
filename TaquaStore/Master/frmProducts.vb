...
Public Class frmProducts
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtSCat.Text.Trim = "" Then
            MsgBox("Category not selected..!", vbCritical)
            txtSCat.Focus()
            Exit Sub
        ElseIf TG.Rows.Count = 0 Then
            MsgBox("No products to save..!", vbCritical)
            Exit Sub
        End If
    ...
    Private Sub AddProductRows(ByVal e As Object)
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If txtPlucode.Text.Trim = "" Then
                MsgBox("Product code cannot be blank..!", vbCritical)
                txtPlucode.Focus()
                Exit Sub
            ElseIf Val(txtCostPrice.Text) <= 0 Or Val(txtRetail.Text) <= 0 Then
                MsgBox("Cost price and retail price cannot be zero..!", vbCritical)
                txtCostPrice.Focus()
                Exit Sub
            ElseIf Val(txtStart.Text) > Val(txtEnd.Text) Then
                MsgBox("End size cannot less then stating size..!", vbCritical)
                txtEnd.Focus()
                Exit Sub
    ...
    Private Sub btnAddColors_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShowColor.Click
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        'If SearchTheTreeView(TVCat, txtSCat.Text) Is Nothing Then
        '    MessageBox.Show("No Match Found")
        'Else
        '    TVCat.SelectedNode = SearchTheTreeView(TVCat, txtSCat.Text)
        'End If

        'Dim ND As TreeNode() = TVCat.Nodes.Find("VEST", True)
        'For Each d As TreeNode In ND
        '    MsgBox(d.Text)
        'Next

    End Sub

    Private Sub txtSCat_TextChanged(sender As Object, e As EventArgs) Handles txtSCat.TextChanged

    End Sub

    Private Sub txtSCat_KeyUp(sender As Object, e As KeyEventArgs) Handles txtSCat.KeyUp
    ...
    Private Sub TVCat_AfterSelect(sender As Object, e As TreeViewEventArgs) Handles TVCat.AfterSelect
